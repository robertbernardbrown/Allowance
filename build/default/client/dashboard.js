...
class Dashboard extends PolymerElement {
  ...
  addTransaction(e) {
    ...
    console.log(date, transactionType, transactionReceipt, transactionAmount); // create addBudget function to simplify POST request to fetch
    ...
    addTransaction(`https://allowance-api.herokuapp.com/api/transactions/${Auth.getId()}`, {
