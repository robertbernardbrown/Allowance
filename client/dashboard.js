...
class Dashboard extends PolymerElement {
    ...
    addBudget (e) {
        ...
        let date = new Date();
        date.setFullYear(this.$.budgetYearSelect.value, this.parseMonth(1), 1);
        ...
        addBudget(`https://allowance-api.herokuapp.com/api/budgets/${Auth.getId()}`, {budget:this.budget, budgetDate:date})
        .then(res => res.json())
        .then(data => {
            console.log(data);
